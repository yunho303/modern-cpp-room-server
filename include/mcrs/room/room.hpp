...
{
public:
    [[nodiscard]] std::expected<RoomEvent, RoomCommandError> apply(const RoomCommand& command);
...
private:
    [[nodiscard]] std::expected<RoomEvent, RoomCommandError> apply_join(const JoinCommand& command);
    [[nodiscard]] std::expected<RoomEvent, RoomCommandError> apply_move(const MoveCommand& command);
    [[nodiscard]] std::expected<RoomEvent, RoomCommandError> apply_leave(const LeaveCommand& command);
